  ...
  return (
    <header className="mx-auto flex max-w-6xl flex-col items-center gap-4 px-5 pt-12 pb-8 text-center sm:pt-16">
      ...
      <div className="flex flex-wrap items-center justify-center gap-3 text-sm text-ink-mute no-print">
        ...
        {marca.enlace && (
          <a
            href={marca.enlace.startsWith("http") ? marca.enlace : `https://${marca.enlace}`}
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center gap-1.5 underline decoration-dotted underline-offset-4 transition-opacity hover:opacity-70"
          >
